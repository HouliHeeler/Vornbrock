...
const OurTeam = () => {
  return (
    <div className='mainDiv'>
      <section>
        <img className='mainImages' src={process.env.PUBLIC_URL + '/images/transfer/mainimages/teamheading.jpg'} alt='decorative art'></img>
        <h1 className ='teamHeader'>Our Team</h1>
      </section>
      <section className='teamInfo'>
        <section className='teamMember'>
          <img className='teamImages' src={process.env.PUBLIC_URL + '/images/transfer/ourteam/kate.jpg'} alt='Kate Bailey'></img>
          <section className='teamBlurb'>
        ...
        <section className='teamMember'>
          <img className='teamImages' src={process.env.PUBLIC_URL + '/images/transfer/ourteam/june.jpg'} alt='June Kim'></img>
          <section className='teamBlurb'>
        ...
        <section className='teamMember'>
          <img className='teamImages' src={process.env.PUBLIC_URL + '/images/transfer/ourteam/paula.jpg'} alt='Paula Costa'></img>
          <section className='teamBlurb'>
        ...
        <section className='teamMember'>
          <img className='teamImages' src={process.env.PUBLIC_URL + '/images/transfer/ourteam/breanne.jpg'} alt='Breanne DeVita'></img>
          <section className='teamBlurb'>
